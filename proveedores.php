...
<head>
    ...
    <meta name="description" content="<?php echo seo_meta_descripcion(9, $prefix); ?>">
    <meta name="author" content="<?php echo $author; ?>">
    <base href="<?php echo $baseurl; ?>">

    <title><?php echo seo_meta_titulo(9, $prefix); ?> | <?php echo $sitio; ?></title>
...
<body class="home-page is-dropdn-click has-slider">
    ...
    <div class="page-content">
        ...
        ?>
        <div class="holder padding-bottom-80 margin-top-0 holder-gris" style="overflow:hidden;">
            <div class="container">
                <h2 class="h1-style text-center h1-style-aboutus margin-top-50 margin-bottom-80">Nuestros Partners</h2>
                <div class="clearfix"></div>
                <ul class="row listado-proveedores" id="listado-proveedores">
                    ...
                    ?>
                    	<li class="col-xs-6 col-sm-3 col-md-2 col-lg-2">
                            <a href="<?php echo $baseurl; ?>catalogo/proveedores/<?php echo $data_sql_while['seourl']; ?>/pag-1/precio-todos/orden-todos.html">
                                <img src="<?php echo $baseurl; ?>/supplyme-images/proveedores/<?php echo $data_sql_while['archivo']; ?>" data-src="<?php echo $baseurl; ?>/supplyme-images/proveedores/<?php echo $data_sql_while['archivo']; ?>" alt="<?php echo $data_sql_while['razon_social']; ?>">
                            </a>
                        </li>
                    <?php } } ?>
                </ul>
            </div>
            <div class="paginas" style="text-align: center;"></div>
        </div>
        <?php } ?>
    </div>
    ...
    <script type="text/javascript">
        $(function(){
          $("div.paginas").jPages({
            containerID : "listado-proveedores",
            perPage     : 18,
            first: false,
            last: false
          });
